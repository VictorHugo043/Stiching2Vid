...
def _extract_result_row(repo_root: Path, suite_id: str, method: str, pair_id: str, run_id: str) -> Dict[str, object]:
    ...
    pair_meta = {
        ...
        "avg_geometry_event_total_ms": metrics.get("avg_geometry_event_total_ms"),
        ...
        "method_b_requested_device": metrics.get("method_b_requested_device"),
        "method_b_resolved_device": metrics.get("method_b_resolved_device"),
        "method_b_device_resolution_reason": metrics.get("method_b_device_resolution_reason"),
